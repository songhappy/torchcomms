...
export LOCAL_SIZE
CPU_BIND=${CPU_BIND:-list:2-4:10-12:18-20:26-28:34-36:42-44:54-56:62-64:70-72:78-80:86-88:94-96}
export CPU_BIND

# Keep CPU binding and CCL worker threads aligned with the topology guidance.
case "$LOCAL_SIZE" in
  12)
